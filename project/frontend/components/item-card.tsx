    ...
    <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-shadow border border-border overflow-hidden">
      <div className="p-4 md:p-6">
        <div className="flex items-start justify-between mb-3 md:mb-4">
          ...
          <span
            className={`px-2 py-0.5 md:px-3 md:py-1 rounded-full text-[10px] md:text-xs font-semibold ${item.statusMesin === "Normal" ? "bg-green-100 text-green-700" :
        ...
        <p className="text-xs md:text-sm text-foreground mb-3 md:mb-4 line-clamp-2">{item.description}</p>
